...
const amenities = JSON.parse(fs.readFileSync(path.join(dataDir, "amenities.json"), "utf-8"));
const agents = JSON.parse(fs.readFileSync(path.join(dataDir, "agents.json"), "utf-8"));
const properties = JSON.parse(fs.readFileSync(path.join(dataDir, "properties.json"), "utf-8"));
