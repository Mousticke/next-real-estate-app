...
const leadsData = [
  ...
  },
  {
    ...
    message: "My family is relocating from San Francisco and we're looking for a luxury property in Malibu. This villa caught our attention. Can we arrange a viewing next week?",
    status: "contacted",
    daysAgo: 5,
  },
  ...
  // Leads for Elegant Beverly Hills Estate (sonny_property_2)
  {
    ...
    message: "I represent a high-profile client interested in Beverly Hills estates. This property matches their requirements. Please contact me to discuss further.",
    status: "new",
    daysAgo: 0,
  },
  {
    ...
    message: "Beautiful estate! I have a buyer pre-approved for up to $10M looking in Beverly Hills. Is this still available? Can we schedule a showing ASAP?",
    status: "contacted",
    daysAgo: 3,
  },
  {
    ...
    message: "Interested in this property as an investment. What's the rental potential in this area? Would like to discuss numbers.",
    status: "closed",
    daysAgo: 14,
  },
  ...
  // Leads for Luxurious Downtown Penthouse (sonny_property_3)
  {
    ...
    message: "I work downtown and have been looking for a penthouse for over a year. This looks amazing! When can I see it?",
    status: "new",
    daysAgo: 2,
  },
  {
    ...
    message: "Just sold my company and looking to upgrade to a luxury condo downtown. This penthouse is exactly what I had in mind. Very interested!",
    status: "contacted",
    daysAgo: 7,
  },
  ...
  // Leads for Contemporary Santa Monica Beach House (sonny_property_4)
  {
    ...
    message: "I'm an interior designer and absolutely love the contemporary design of this beach house. Looking to buy for personal use. Please reach out!",
    status: "new",
    daysAgo: 1,
  },
  {
    ...
    message: "Moving from San Diego for work. Santa Monica is my target area and this property looks perfect. Can we set up a virtual tour first?",
    status: "new",
    daysAgo: 0,
  },
  ...
  // Leads for Mid-Century Modern in Hollywood Hills (sonny_property_5)
  {
    ...
    message: "I'm a huge fan of mid-century modern architecture. This property is stunning! Would love to see it in person.",
    status: "contacted",
    daysAgo: 4,
  },
  {
    ...
    message: "As an architect, I appreciate the craftsmanship of this era. Very interested in making an offer. What's the current status?",
    status: "new",
    daysAgo: 2,
  },
  ...
  // Leads for Spanish Colonial in Los Feliz (sonny_property_6 - pending status)
  {
    ...
    message: "This Spanish Colonial is breathtaking! I've always dreamed of owning a historic home in Los Feliz. Is the pending status firm or still accepting backup offers?",
    status: "contacted",
    daysAgo: 8,
  },
  ...
  // Leads for Sleek West Hollywood Condo (sonny_property_7)
  {
    ...
    message: "Love the WeHo location and modern design. This is exactly my style. First-time buyer here - would appreciate guidance through the process.",
    status: "new",
    daysAgo: 1,
  },
  {
    ...
    message: "Relocating from SF for a new job. Looking for a modern condo in a walkable neighborhood. This checks all my boxes!",
    status: "contacted",
    daysAgo: 6,
  },
  ...
  // Leads for Craftsman Bungalow in Pasadena (sonny_property_8)
  {
    ...
    message: "I'm a professor at Caltech and love the Bungalow Heaven neighborhood. This house is charming! When can we schedule a showing?",
    status: "new",
    daysAgo: 3,
  },
  {
    ...
    message: "Looking for a family home in Pasadena with character. This Craftsman is perfect! The studio would be great for my home office.",
    status: "new",
    daysAgo: 0,
  },
  ...
  // Leads for Modern Townhome in Playa Vista (sonny_property_9)
  {
    ...
    message: "I work at Google's Playa Vista office and have been looking for a place nearby. This townhome is ideal - walking distance to work!",
    status: "contacted",
    daysAgo: 5,
  },
  {
    ...
    message: "Transferring to the LA office from Seattle. Playa Vista seems like the perfect neighborhood for tech workers. Very interested!",
    status: "new",
    daysAgo: 2,
  },
  ...
  // Leads for Architectural Gem in Silver Lake (sonny_property_10)
  {
    ...
    message: "Silver Lake has been my dream neighborhood for years. This architectural gem is exactly what I've been waiting for. Please contact me immediately!",
    status: "new",
    daysAgo: 0,
  },
  {
    ...
    message: "As a gallery owner, I appreciate unique architecture. This home would be perfect for hosting intimate art events. Very interested in viewing!",
    status: "contacted",
    daysAgo: 9,
  },
];

async function findAgentByEmail(email: string): Promise<{ _id: string; name: string } | null> {
  const agent = await client.fetch(`*[_type == "agent" && email == $email][0]{ _id, name }`, { email });
  return agent;
}
