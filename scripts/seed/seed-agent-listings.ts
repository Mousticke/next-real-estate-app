...
const agentListings = [
  {
    ...
    amenities: ["pool", "garage", "fireplace", "central-ac", "smart-home", "security-system", "ocean-view", "home-theater"],
    featured: true,
    imageUrls: [
  ...
  },
  {
    ...
    amenities: ["pool", "garage", "fireplace", "central-ac", "smart-home", "security-system", "wine-cellar", "guest-house", "home-theater", "hot-tub"],
    featured: true,
    imageUrls: [
  ...
  },
  {
    ...
    amenities: ["pool", "gym", "parking", "central-ac", "smart-home", "security-system", "city-view", "doorman", "wine-cellar"],
    featured: true,
    imageUrls: [
  ...
  },
  {
    ...
    amenities: ["garage", "fireplace", "central-ac", "smart-home", "security-system", "ocean-view", "balcony", "hardwood-floors"],
    featured: true,
    imageUrls: [
  ...
  },
  {
    ...
    amenities: ["pool", "garage", "fireplace", "central-ac", "hardwood-floors", "city-view"],
    featured: false,
    imageUrls: [
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200",
  ...
  },
  {
    ...
    amenities: ["pool", "garage", "fireplace", "garden", "hardwood-floors", "guest-house"],
    featured: false,
    imageUrls: [
  ...
  },
  {
    ...
    amenities: ["pool", "gym", "parking", "central-ac", "smart-home", "doorman", "rooftop-deck"],
    featured: false,
    imageUrls: ["https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200", "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1200"],
  },
  {
  ...
  },
  {
    ...
    amenities: ["garage", "central-ac", "smart-home", "rooftop-deck", "washer-dryer"],
    featured: false,
    imageUrls: ["https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=1200", "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=1200"],
  },
  {
    ...
    amenities: ["garage", "fireplace", "central-ac", "hardwood-floors", "balcony", "city-view"],
    featured: false,
    imageUrls: [
      "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200",
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200",
...
async function uploadImage(url: string): Promise<string | null> {
  try {
    ...
    const asset = await client.assets.upload("image", Buffer.from(buffer) as unknown as Blob, {
...
async function main() {
  ...
  try {
    ...
    if (!agent) {
      ...
      console.error("Make sure the agent has completed onboarding before running this script.");
      process.exit(1);
    }
