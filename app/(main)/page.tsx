      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-accent via-accent/50 to-background py-24 md:py-32 lg:py-40">
        ...
        <div className="container relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Search Bar */}
            <form action="/properties" method="GET" className="flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto">
              <div className="flex-1 relative">
                ...
                <Input id="city-search" name="city" placeholder="Enter city, neighborhood, or ZIP…" autoComplete="address-level2" className="h-14 pl-12 text-base" />
              </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold font-heading">Featured Properties</h2>
              <p className="text-muted-foreground mt-2">Hand-picked homes curated just for you</p>
            </div>
      ...
      <section className="py-20 md:py-28 bg-accent/30">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold font-heading">How Nestwell Works</h2>
            <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">Finding your first home has never been easier. Follow these simple steps to start your journey.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="relative text-center group">
              ...
              <span className="inline-block px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium mb-3">Step 1</span>
              <h3 className="text-xl font-semibold font-heading mb-3">Search Properties</h3>
              <p className="text-muted-foreground">Browse our curated catalog with advanced filters, map view, and neighborhood insights.</p>
            </div>
            ...
            <div className="relative text-center group">
              ...
              <div className="absolute top-10 left-[60%] right-0 h-px bg-border hidden md:block" aria-hidden="true" />
              <span className="inline-block px-3 py-1 rounded-full bg-secondary/10 text-secondary-foreground text-sm font-medium mb-3">Step 2</span>
              <h3 className="text-xl font-semibold font-heading mb-3">Save Favorites</h3>
              <p className="text-muted-foreground">Save properties you love and compare them side by side to find your perfect match.</p>
            </div>
            ...
            <div className="relative text-center group">
              ...
              <span className="inline-block px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium mb-3">Step 3</span>
              <h3 className="text-xl font-semibold font-heading mb-3">Connect with Agents</h3>
              <p className="text-muted-foreground">Reach out to trusted agents, schedule viewings, and get expert guidance throughout your journey.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <span className="inline-block px-3 py-1 rounded-full bg-secondary/10 text-secondary-foreground text-sm font-medium mb-4">Why Choose Nestwell</span>
              <h2 className="text-3xl md:text-4xl font-bold font-heading mb-6">Built for First-Time Homebuyers</h2>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Every property is verified by our team to ensure accuracy and quality.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Connect with experienced agents who specialize in helping first-time buyers.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Save favorites, get recommendations, and track your home search journey.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-primary to-primary/80 rounded-3xl p-8 md:p-12 text-primary-foreground">
              <h3 className="text-2xl md:text-3xl font-bold font-heading mb-8">Trusted by Thousands</h3>
        ...
        <div className="container">
          <div className="bg-gradient-to-r from-secondary/90 to-secondary rounded-3xl p-8 md:p-12 lg:p-16">
            <div className="max-w-3xl">
              <h2 className="text-3xl md:text-4xl font-bold font-heading mb-4 text-secondary-foreground">Are You a Real Estate Agent?</h2>
