...
import { ArrowLeft, CreditCard, Home, LayoutDashboard, ListPlus, MessageSquare, User } from "lucide-react";
    ...
    <aside className="w-72 border-r border-border/50 bg-sidebar min-h-screen sticky top-0">
      <div className="p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage your listings and leads</p>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "bg-primary text-primary-foreground shadow-warm" : "text-muted-foreground hover:text-foreground hover:bg-sidebar-accent",
                )}
